...
public class MybatisCodeGenerate {
    // -custom
    private static String[] tableNames = new String[]{"sys_role","sys_user_role","sys_permission","sys_role_permission"};
    // 程序会自动找到basePath
    private static String basePath = null;

    private static Logger log = LoggerFactory.getLogger(MybatisCodeGenerate.class);

    private static final String DAO_PACKAGE = "com.janita.url.dao" ;
    ...
    public void codegenForOneTable(String oneTableName) throws Exception {
        ...
        String modalPackage = "com.janita.url.entity";
        String daoPackage = "com.janita.url.dao";
